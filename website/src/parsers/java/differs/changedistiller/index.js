...
const ID = 'ChangeDistiller';
const VERSION = '0.0.0';
const HOMEPAGE = 'https://github.com/gstahhtstehdrtghbrdstbhrfsb/ChangeDistiller';
const PARSER_SERVICE_URL = 'http://131.254.17.96:8085/diff/ChangeDistiller';
